...
public class AIService {
    ...
    public AIService(AIHistoryRepository aiHistoryRepository) {
    ...
    /**
     * Lấy lịch sử AI của giáo viên
     */
    public List<AIHistory> getHistoryByTeacher(User teacher) {
        return aiHistoryRepository.findByTeacherOrderByCreatedAtDesc(teacher);
    }
}
